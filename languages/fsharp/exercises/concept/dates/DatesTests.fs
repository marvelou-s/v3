...
type AppointmentTests() =
    ...
    let ``Description on Friday afternoon``() =
        description (DateTime(2019, 03, 29, 15, 0, 0)) |> should equal "You have an appointment on 3/29/2019 3:00:00 PM." 

    [<Fact>]
    let ``Description on Thursday afternoon``() =
        description (DateTime(2019, 07, 25, 13, 45, 0)) |> should equal "You have an appointment on 7/25/2019 1:45:00 PM." 
